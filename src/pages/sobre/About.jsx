    ...
    <div>
      ...
      <div className={styles.listarecursos}>
        <div className={styles.recurso}>
          ...
          <p>
            Personalize seu plano de estudos com base no estado e exame
            específico para o qual você está se preparando.
          </p>
        </div>
        <div className={styles.recurso}>
          <h2>Horário</h2>
      ...
      <div className={styles.listarecursos}>
        <div className={styles.recurso}>
          ...
          <p>
            Planeje para curto ou longo prazo com agendas de 1 semana, 1 mês ou
            3 meses.
          </p>
        </div>
        <div className={styles.recurso}>
